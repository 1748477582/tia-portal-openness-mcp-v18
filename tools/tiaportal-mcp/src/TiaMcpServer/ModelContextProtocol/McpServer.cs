...
namespace TiaMcpServer.ModelContextProtocol
{
    ...
    public static partial class McpServer
    {
        ...
        public static ResponseConnect Connect()
        {
            ...
            {
                throw McpError.WithRecovery(pex, $"Failed to connect to TIA-Portal [{pex.Code}]: {pex.Message}");
            }
            catch (Exception ex) when (ex is not McpException)
            {
                throw McpError.WithRecovery(ex, $"Unexpected error connecting to TIA-Portal: {ex.Message}{McpHints.Recovery(ex)}");
            }
        }
        ...
        public static ResponseStringList ListPortalProcessProjects()
        {
            ...
            {
                throw McpError.WithRecovery(ex, $"Unexpected error listing TIA Portal processes: {ex.Message}{McpHints.Recovery(ex)}");
            }
        }
        ...
        public static async Task<ResponseMessage> EnsureOpennessUserGroup()
        {
            ...
            {
                throw McpError.WithRecovery(ex, $"Unexpected error ensuring Openness user group: {ex.Message}{McpHints.Recovery(ex)}");
            }
        }
        ...
        public static ResponseDisconnect Disconnect()
        {
            ...
            {
                throw McpError.WithRecovery(ex, $"Unexpected error disconnecting from TIA-Portal: {ex.Message}{McpHints.Recovery(ex)}");
            }
        }
        ...
        public static ResponseState GetState()
        {
            ...
            {
                throw McpError.WithRecovery(ex, $"Unexpected error retrieving TIA-Portal MCP server state: {ex.Message}{McpHints.Recovery(ex)}");
            }
        }
        ...
        public static async Task<ResponseBootstrap> Bootstrap()
        {
            ...
            {
                throw McpError.WithRecovery(ex, $"Bootstrap unexpected error: {ex.Message}{McpHints.Recovery(ex)}");
            }
        }
            ...
            [Description("Expected HMI software path for ValidateAutomationContext.")] string expectedHmiSoftwarePath = "HMI_RT_1")
        {
            ...
            {
                throw McpError.WithRecovery(ex, $"Unexpected error running capability self-test: {ex.Message}{McpHints.Recovery(ex)}");
            }
        }
        ...
        public static ResponseSafetySelfTest RunOnlineMonitoringSafetySelfTest()
        {
            ...
            {
                throw McpError.WithRecovery(ex, $"Unexpected error running online monitoring safety self-test: {ex.Message}{McpHints.Recovery(ex)}");
            }
        }
        ...
        // [DISABLED-A] [McpServerTool(Name = "GenerateAcceptanceReport"), Description("[L0][Reports]Generate a read-only acceptance report for the current MCP/TIA environment. The default mode does not attach to TIA or write to the project; it writes Markdown/JSON report files to outputDirectory.")]
            ...
            [Description("Optional report title.")] string title = "TIA MCP Acceptance Report")
        {
            ...
            {
                throw McpError.WithRecovery(ex, $"Unexpected error generating acceptance report: {ex.Message}{McpHints.Recovery(ex)}");
            }
        }
        ...
        // [DISABLED-A] [McpServerTool(Name = "GenerateErrorReport"), Description("[L0][Reports]Generate a standardized Markdown/JSON error report. This is file/report generation only; it does not touch TIA Portal or modify projects.")]
            ...
            [Description("Directory where the Markdown and JSON reports will be written. Empty means a temp directory under %TEMP%.")] string outputDirectory = "")
        {
            ...
            {
                throw McpError.WithRecovery(ex, $"Unexpected error generating error report: {ex.Message}{McpHints.Recovery(ex)}");
            }
        }
